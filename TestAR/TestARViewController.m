...
//  TestAR
//
//  Created by 泥巴 on 2017/10/30.
//  Copyright © 2017年 scn. All rights reserved.
//

#import "TestARViewController.h"

@interface TestARViewController ()<ARSCNViewDelegate,ARSessionDelegate>
{
    BOOL alreadyFound;
}
...
-(void)initNode{
    ...
    _sunNode.position = SCNVector3Make(0,-200,-400);
...
-(void)roationNode{
    ...
    // 添加飞船
    SCNNode *ship = [self.sceneView.scene.rootNode childNodeWithName:@"ship" recursively:YES];
